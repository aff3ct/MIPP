...
{
	std::cout << name << " = [";
	for (uint32_t i = 0; i < mipp::N<int32_t,LMUL>(); i++)
		std::cout << v[i] << ",";
	std::cout << "]" << std::endl;
}
...
{
	int32_t a1[mipp::N<int32_t,LMUL>()];
	int32_t a2[mipp::N<int32_t,LMUL>()];
	int32_t a3[mipp::N<int32_t,LMUL>()];
	...
	mipp::rvd<int32_t,LMUL> rvd1, rvd2, rvd3;

	rvd1 = mipp::load<int32_t,LMUL>(a1);
	rvd2 = mipp::load<int32_t,LMUL>(a2);
