...
rvm_avx512_float64_t mipp_avx512_set_float64() {
	rvm_avx512_float64_t res;
	res.m = 	mipp_avx512_cast_k_float64_float64(_mm512_set_pd(vals[7], vals[6], vals[5], vals[4], vals[3], vals[2], vals[1], vals[0]));
	return res;
}
#endif
// ---------------------------------------------------------------------------------------------------------------------------------------------- set
...
rvm_avx512_float32_t mipp_avx512_set_float32() {
	rvm_avx512_float32_t res;
	res.m = 	_mm512_set_ps(vals[15], vals[14], vals[13], vals[12],vals[11], vals[10], vals[ 9], vals[ 8],
...
rvm_avx512_int32_t mipp_avx512_set_int32() {
	rvm_avx512_int32_t res;
	res.m =  rcast_k<c:float,tp>%(_mm512_castsi512_ps(_mm512_set_epi32(vals[15], vals[14], vals[13], vals[12], vals[11], vals[10], vals[ 9], vals[ 8],                                            					
																	 vals[ 7], vals[ 6], vals[ 5], vals[ 4],vals[ 3], vals[ 2], vals[ 1], vals[ 0])));
	return res;
}
#endif
...
rvm_avx512_int64_t mipp_avx512_set_int64() {
	rvm_avx512_int64_t res;
	res.m = 	mipp_avx512_cast_k_float64_int64(_mm512_set_epi64((vals[15], vals[14], vals[13], vals[12],
