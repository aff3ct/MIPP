...
rvd_avx512_int32_t mipp_avx512_fmadd_int32(const rvd_avx512_int32_t r0, const rvd_avx512_int32_t r1, const rvd_avx512_int32_t r2) {
	rvd_avx512_int32_t res;
	res.m = _mm512_fmadd_epi32(r0.m, r1.m, r2.m);
	return res;
}
#endif
rvd_avx512_float64_t mipp_avx512_fmsub_float64(const rvd_avx512_float64_t r0, const rvd_avx512_float64_t r1, const rvd_avx512_float64_t r2) {
	rvd_avx512_float64_t res;
	res.m = _mm512_fmsub_pd(r0.m, r1.m, r2.m);
	return res;
}
...
float64_t mipp_avx512_round_float64(const rvd_avx512_float64_t r0) {
 _mm512_roundscale_pd(r0.m, 0, _MM_FROUND_TO_NEAREST_INT | _MM_FROUND_NO_EXC);
}
float32_t mipp_avx512_round_float32(const rvd_avx512_float32_t r0) {
 _mm512_roundscale_ps(r0.m, 0, _MM_FROUND_TO_NEAREST_INT | _MM_FROUND_NO_EXC);
}
#if defined(__MIC__) || defined(__KNCNI__) || defined(__AVX512__) || defined(__AVX512F__) && (( ( ( defined(__AVX512F__) ) ) ))
rvd_avx512_float64_t mipp_avx512_blend_float64(const rvd_avx512_float64_t r0, const rvd_avx512_float64_t r1, const rvm_avx512_float64_t m0) {
	rvd_avx512_float64_t res;
	res.m = _mm512_mask_blend_pd(r0.m, r1.m, mipp_avx512_toreg_float64(m0).m);
	return res;
}
#endif
#if defined(__MIC__) || defined(__KNCNI__) || defined(__AVX512__) || defined(__AVX512F__) && (( ( ( defined(__AVX512F__) ) ) ))
rvd_avx512_float32_t mipp_avx512_blend_float32(const rvd_avx512_float32_t r0, const rvd_avx512_float32_t r1, const rvm_avx512_float32_t m0) {
	rvd_avx512_float32_t res;
	res.m = _mm512_mask_blend_ps(r0.m, r1.m, mipp_avx512_toreg_float32(m0).m);
	return res;
}
#endif
#if defined(__MIC__) || defined(__KNCNI__) || defined(__AVX512__) || defined(__AVX512F__) && (( ( ( defined(__AVX512F__) ) ) ))
rvd_avx512_int64_t mipp_avx512_blend_int64(const rvd_avx512_int64_t r0, const rvd_avx512_int64_t r1, const rvm_avx512_int64_t m0) {
	rvd_avx512_int64_t res;
	res.m = _mm512_mask_blend_epi64(r0.m, r1.m, mipp_avx512_toreg_int64(m0).m);
	return res;
}
#endif
#if defined(__MIC__) || defined(__KNCNI__) || defined(__AVX512__) || defined(__AVX512F__) && (( ( ( defined(__AVX512F__) ) ) ))
rvd_avx512_int32_t mipp_avx512_blend_int32(const rvd_avx512_int32_t r0, const rvd_avx512_int32_t r1, const rvm_avx512_int32_t m0) {
	rvd_avx512_int32_t res;
	res.m = _mm512_mask_blend_epi32(r0.m, r1.m, mipp_avx512_toreg_int32(m0).m);
	return res;
}
#endif
...
rvd_avx512_int8_t mipp_avx512_blend_int8(const rvd_avx512_int8_t r0, const rvd_avx512_int8_t r1, const rvm_avx512_int8_t m0) {
	rvd_avx512_int8_t res;
	res.m = _mm512_mask_blend_epi8(r0.m, r1.m, mipp_avx512_toreg_int8(m0).m);
	return res;
}
#endif
#if defined(__AVX512BW__) && (( ( ( defined(__AVX512F__) ) ) ))
rvd_avx512_int16_t mipp_avx512_blend_int16(const rvd_avx512_int16_t r0, const rvd_avx512_int16_t r1, const rvm_avx512_int16_t m0) {
	rvd_avx512_int16_t res;
	res.m = _mm512_mask_blend_epi16(r0.m, r1.m, mipp_avx512_toreg_int16(m0).m);
	return res;
}
#endif
#if defined(__AVX512F__) && (( ( ( defined(__AVX512F__) ) ) ) && ( ( ( defined(__AVX512F__) ) ) ))
...
#endif
#if defined(__AVX512F__) && (( ( ( defined(__AVX512F__) ) ) ))
rvd_avx512_float64_t mipp_avx512_set_float64(const float64_t v0) {
	rvd_avx512_float64_t res;
	res.m = 	return mipp_avx512_cast_k_float64_float64(_mm512_set_pd(vals[7], vals[6], vals[5], vals[4], vals[3], vals[2], vals[1], vals[0]));
	return res;
}
#endif
#if defined(__AVX512F__)
rvd_avx512_float32_t mipp_avx512_set_float32(const float32_t v0) {
	rvd_avx512_float32_t res;
	res.m = 	return _mm512_set_ps(vals[15], vals[14], vals[13], vals[12],vals[11], vals[10], vals[ 9], vals[ 8],
...
#endif
#if defined(__AVX512F__) && (( ( ( defined(__AVX512F__) ) ) ))
rvd_avx512_int64_t mipp_avx512_set_int64(const int64_t v0) {
	rvd_avx512_int64_t res;
...
#endif
#if defined(__AVX512BW__) && (( ( ( defined(__AVX512F__) ) ) ) && ( ( ( defined(__AVX512F__) && (( ( ( defined(__AVX512F__) ) ) )) && (( ( ( defined(__AVX512F__) ) ) )) ) ) ) && ( ( ( defined(__AVX512F__) ) ) ) && ( ( ( defined(__AVX512F__) ) ) ))
...
#endif
#if ( ( ( defined(__AVX512F__) ) ) ) && ( ( ( defined(__AVX512F__) ) ) ) && ( ( ( defined(__AVX512BW__) ) ) )
...
#endif
#if !( defined(__AVX512F__) ) && ( defined(__MIC__) || defined(__KNCNI__) && (( ( ( defined(__AVX512F__) ) ) )) )
rvd_avx512_float64_t mipp_avx512_set0_float64() {
...
rvm_avx512_float64_t mipp_avx512_set0_k_float64() {
	rvm_avx512_float64_t res;
	res.m =  rvd_avx512_int64_t r32 = 0;
	rvm_avx512_int32_t m32 = mipp_avx512_tomsk_int32(r32);
    return _mm512_kxor(m32, m32);
	return res;
}
rvm_avx512_float32_t mipp_avx512_set0_k_float32() {
	rvm_avx512_float32_t res;
	res.m =  rvd_avx512_int32_t r32 = 0;
	rvm_avx512_int32_t m32 = mipp_avx512_tomsk_int32(r32);
    return _mm512_kxor(m32, m32);
	return res;
}
...
rvm_avx512_int16_t mipp_avx512_set0_k_int16() {
	rvm_avx512_int16_t res;
	res.m =  rvd_avx512_int16_t r32 = 0;
	rvm_avx512_int32_t m32 = mipp_avx512_tomsk_int32(r32);
    return _mm512_kxor(m32, m32);
	return res;
}
...
#if defined (__AVX512BW__) && (( ( ( defined(__AVX512F__) ) ) ) && ( ( ( defined(__AVX512BW__) ) ) ) && ( ( ( defined(__AVX512F__) ) ) ))
int32_t mipp_avx512_testz_int16(const rvm_avx512_int16_t m0, const rvm_avx512_int16_t m1) {
	rvd_avx512_int16_t r32 = mipp_avx512_set0_int16();
	rvm_avx512_int32_t m32 = mipp_avx512_tomsk_int32(r32);
	rvd_avx512_int16_t msk = mipp_avx512_cmpneq_int16(r0, m32);				
	return mipp_avx512_cast_int16_int16(msk == 0);
}
#endif
