...
#define MIPP_MACRO_GEN_RV(INSTR_NAME_SMALL, DATA_OR_MASK, FULL_TYPE, UNUSED_INTEL_TYPE, UNUSED_INTEL_LDST_TYPE, UNUSED_CAST_TYPE) \
  typedef rv##DATA_OR_MASK##_##INSTR_NAME_SMALL##_##FULL_TYPE##_t rv##DATA_OR_MASK##_##FULL_TYPE##_t;
...
#define MIPP_MACRO_LOAD_GENERIC(INSTR_NAME_SMALL, MIPP_NAME, FULL_TYPE, UNUSED_INTEL_TYPE, UNUSED_INTEL_LDST_TYPE, UNUSED_CAST_TYPE) \
  rvd_##FULL_TYPE##_t mipp_##MIPP_NAME##_##FULL_TYPE(FULL_TYPE##_t *mem_addr) { \
    return (rvd_##FULL_TYPE##_t) mipp_##INSTR_NAME_SMALL##_##MIPP_NAME##_##FULL_TYPE(mem_addr); \
  }
...
#define MIPP_MACRO_STORE_GENERIC(INSTR_NAME_SMALL, MIPP_NAME, FULL_TYPE, UNUSED_INTEL_TYPE, UNUSED_INTEL_LDST_TYPE, UNUSED_CAST_TYPE) \
  void mipp_##MIPP_NAME##_##FULL_TYPE(FULL_TYPE##_t *mem_addr, rvd_##FULL_TYPE##_t rvd) { \
    mipp_##INSTR_NAME_SMALL##_##MIPP_NAME##_##FULL_TYPE(mem_addr, (rvd_##INSTR_NAME_SMALL##_##FULL_TYPE##_t) rvd); \
  }
...
#define MIPP_MACRO_ARITHMETIC_2ARGS_GENERIC(INSTR_NAME_SMALL, MIPP_NAME, FULL_TYPE, UNUSED_INTEL_TYPE, UNUSED_INTEL_LDST_TYPE, UNUSED_CAST_TYPE) \
  rvd_##FULL_TYPE##_t mipp_##MIPP_NAME##_##FULL_TYPE(rvd_##FULL_TYPE##_t rvd1, rvd_##FULL_TYPE##_t rvd2) { \
    return (rvd_##FULL_TYPE##_t) mipp_##INSTR_NAME_SMALL##_##MIPP_NAME##_##FULL_TYPE((rvd_##INSTR_NAME_SMALL##_##FULL_TYPE##_t) rvd1, (rvd_##INSTR_NAME_SMALL##_##FULL_TYPE##_t) rvd2); \
  }
...
#define MIPP_MACRO_LOAD_LMUL1(MIPP_NAME, FULL_TYPE, UNUSED_INTEL_TYPE, UNUSED_INTEL_LDST_TYPE, UNUSED_CAST_TYPE) \
  rvd_##FULL_TYPE##_m1_t mipp_##MIPP_NAME##_##FULL_TYPE##_m1(FULL_TYPE##_t *mem_addr) { \
    return mipp_##MIPP_NAME##_##FULL_TYPE(mem_addr); \
  }

#define MIPP_MACRO_LOAD_LMULX(MIPP_NAME, LMUL, LMUL_PREV, FULL_TYPE, UNUSED_INTEL_TYPE, UNUSED_INTEL_LDST_TYPE, UNUSED_CAST_TYPE) \
  rvd_##FULL_TYPE##_m##LMUL##_t mipp_##MIPP_NAME##_##FULL_TYPE##_m##LMUL(FULL_TYPE##_t *mem_addr) { \
    rvd_##FULL_TYPE##_m##LMUL##_t rvd; \
    rvd.m1 = mipp_##MIPP_NAME##_##FULL_TYPE##_m##LMUL_PREV(mem_addr); \
    rvd.m2 = mipp_##MIPP_NAME##_##FULL_TYPE##_m##LMUL_PREV(mem_addr + MIPP_LMUL_STRIDE(sizeof(*mem_addr), LMUL_PREV)); \
    return rvd; \
  }
...
#define MIPP_MACRO_STORE_LMUL1(MIPP_NAME, FULL_TYPE, UNUSED_INTEL_TYPE, UNUSED_INTEL_LDST_TYPE, UNUSED_CAST_TYPE) \
  void mipp_##MIPP_NAME##_##FULL_TYPE##_m1(FULL_TYPE##_t *mem_addr, rvd_##FULL_TYPE##_m1_t rvd) { \
    mipp_##MIPP_NAME##_##FULL_TYPE(mem_addr, rvd); \
  }

#define MIPP_MACRO_STORE_LMULX(MIPP_NAME, LMUL, LMUL_PREV, FULL_TYPE, UNUSED_INTEL_TYPE, UNUSED_INTEL_LDST_TYPE, UNUSED_CAST_TYPE) \
  void mipp_##MIPP_NAME##_##FULL_TYPE##_m##LMUL(FULL_TYPE##_t *mem_addr, rvd_##FULL_TYPE##_m##LMUL##_t rvd) { \
    mipp_##MIPP_NAME##_##FULL_TYPE##_m##LMUL_PREV(mem_addr, rvd.m1); \
    mipp_##MIPP_NAME##_##FULL_TYPE##_m##LMUL_PREV(mem_addr + MIPP_LMUL_STRIDE(sizeof(*mem_addr), LMUL_PREV), rvd.m2); \
  }
...
#define MIPP_MACRO_ARITHMETIC_2ARGS_LMUL1(MIPP_NAME, FULL_TYPE, UNUSED_INTEL_TYPE, UNUSED_INTEL_LDST_TYPE, UNUSED_CAST_TYPE) \
  rvd_##FULL_TYPE##_m1_t mipp_##MIPP_NAME##_##FULL_TYPE##_m1(rvd_##FULL_TYPE##_m1_t rvd1, rvd_##FULL_TYPE##_m1_t rvd2) { \
    return mipp_##MIPP_NAME##_##FULL_TYPE(rvd1, rvd2); \
  }

#define MIPP_MACRO_ARITHMETIC_2ARGS_LMULX(MIPP_NAME, LMUL, LMUL_PREV, FULL_TYPE, UNUSED_INTEL_TYPE, UNUSED_INTEL_LDST_TYPE, UNUSED_CAST_TYPE) \
  rvd_##FULL_TYPE##_m##LMUL##_t mipp_##MIPP_NAME##_##FULL_TYPE##_m##LMUL(rvd_##FULL_TYPE##_m##LMUL##_t rvd1, rvd_##FULL_TYPE##_m##LMUL##_t rvd2) { \
    rvd_##FULL_TYPE##_m##LMUL##_t rvd; \
    rvd.m1 = mipp_##MIPP_NAME##_##FULL_TYPE##_m##LMUL_PREV(rvd1.m1, rvd2.m1); \
    rvd.m2 = mipp_##MIPP_NAME##_##FULL_TYPE##_m##LMUL_PREV(rvd1.m2, rvd2.m2); \
    return rvd; \
  }
