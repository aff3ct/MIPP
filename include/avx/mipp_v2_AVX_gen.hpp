...
template<> struct rvm_type<float64_t, 1>{ using type = rvm_avx_float64_t; };
template<> struct rvm_type<float32_t, 1>{ using type = rvm_avx_float32_t; };
template<> struct rvm_type<int64_t, 1>{ using type = rvm_avx_int64_t; };
template<> struct rvm_type<int32_t, 1>{ using type = rvm_avx_int32_t; };
template<> struct rvm_type<int16_t, 1>{ using type = rvm_avx_int16_t; };
template<> struct rvm_type<int8_t, 1>{ using type = rvm_avx_int8_t; };
template<> struct rvm_type<uint64_t, 1>{ using type = rvm_avx_uint64_t; };
template<> struct rvm_type<uint32_t, 1>{ using type = rvm_avx_uint32_t; };
template<> struct rvm_type<uint16_t, 1>{ using type = rvm_avx_uint16_t; };
template<> struct rvm_type<uint8_t, 1>{ using type = rvm_avx_uint8_t; };
...
inline rvd<float64_t,1> load(const float64_t* p0) {
	return mipp_avx_load_float64(p0);
}
inline rvd<float32_t,1> load(const float32_t* p0) {
	return mipp_avx_load_float32(p0);
}
inline rvd<int64_t,1> load(const int64_t* p0) {
	return mipp_avx_load_int64(p0);
}
inline rvd<int32_t,1> load(const int32_t* p0) {
	return mipp_avx_load_int32(p0);
}
inline rvd<int16_t,1> load(const int16_t* p0) {
	return mipp_avx_load_int16(p0);
}
inline rvd<int8_t,1> load(const int8_t* p0) {
	return mipp_avx_load_int8(p0);
}
inline rvd<uint64_t,1> load(const uint64_t* p0) {
	return mipp_avx_load_uint64(p0);
}
inline rvd<uint32_t,1> load(const uint32_t* p0) {
	return mipp_avx_load_uint32(p0);
}
inline rvd<uint16_t,1> load(const uint16_t* p0) {
	return mipp_avx_load_uint16(p0);
}
inline rvd<uint8_t,1> load(const uint8_t* p0) {
	return mipp_avx_load_uint8(p0);
}
inline rvd<float64_t,1> loadu(const float64_t* p0) {
	return mipp_avx_loadu_float64(p0);
}
inline rvd<float32_t,1> loadu(const float32_t* p0) {
	return mipp_avx_loadu_float32(p0);
}
inline rvd<int64_t,1> loadu(const int64_t* p0) {
	return mipp_avx_loadu_int64(p0);
}
inline rvd<int32_t,1> loadu(const int32_t* p0) {
	return mipp_avx_loadu_int32(p0);
}
inline rvd<int16_t,1> loadu(const int16_t* p0) {
	return mipp_avx_loadu_int16(p0);
}
inline rvd<int8_t,1> loadu(const int8_t* p0) {
	return mipp_avx_loadu_int8(p0);
}
inline rvd<uint64_t,1> loadu(const uint64_t* p0) {
	return mipp_avx_loadu_uint64(p0);
}
inline rvd<uint32_t,1> loadu(const uint32_t* p0) {
	return mipp_avx_loadu_uint32(p0);
}
inline rvd<uint16_t,1> loadu(const uint16_t* p0) {
	return mipp_avx_loadu_uint16(p0);
}
inline rvd<uint8_t,1> loadu(const uint8_t* p0) {
...
template <>
inline rvd<float64_t, 1> set(const float64_t vals[MIPP_N_FLOAT64]) {
	return mipp_avx_set_float64( vals);
}
template <>
inline rvd<float32_t, 1> set(const float32_t vals[MIPP_N_FLOAT32]) {
	return mipp_avx_set_float32( vals);
}
template <>
inline rvd<int64_t, 1> set(const int64_t vals[MIPP_N_INT64]) {
	return mipp_avx_set_int64( vals);
}
template <>
inline rvd<int32_t, 1> set(const int32_t vals[MIPP_N_INT32]) {
	return mipp_avx_set_int32( vals);
}
template <>
inline rvd<int16_t, 1> set(const int16_t vals[MIPP_N_INT16]) {
	return mipp_avx_set_int16( vals);
}
template <>
inline rvd<int8_t, 1> set(const int8_t vals[MIPP_N_INT8]) {
	return mipp_avx_set_int8( vals);
}
template <>
inline rvd<uint64_t, 1> set(const uint64_t vals[MIPP_N_UINT64]) {
	return mipp_avx_set_uint64( vals);
}
template <>
inline rvd<uint32_t, 1> set(const uint32_t vals[MIPP_N_UINT32]) {
	return mipp_avx_set_uint32( vals);
}
template <>
inline rvd<uint16_t, 1> set(const uint16_t vals[MIPP_N_UINT16]) {
	return mipp_avx_set_uint16( vals);
}
template <>
inline rvd<uint8_t, 1> set(const uint8_t vals[MIPP_N_UINT8]) {
	return mipp_avx_set_uint8( vals);
}
template <typename T> inline rvm<T, 1> set_k(const int32_t[N<T>()]) { std::cerr << "set_k" << std::endl; exit(-1);}

template <>
inline rvm<float64_t, 1> set_k<float64_t>(const int32_t vals[MIPP_N_FLOAT64]) {
	return mipp_avx_set_k_float64( vals);
}
template <>
inline rvm<float32_t, 1> set_k<float32_t>(const int32_t vals[MIPP_N_FLOAT32]) {
	return mipp_avx_set_k_float32( vals);
}
template <>
inline rvm<int64_t, 1> set_k<int64_t>(const int32_t vals[MIPP_N_INT64]) {
	return mipp_avx_set_k_int64( vals);
}
template <>
inline rvm<int32_t, 1> set_k<int32_t>(const int32_t vals[MIPP_N_INT32]) {
	return mipp_avx_set_k_int32( vals);
}
template <>
inline rvm<int16_t, 1> set_k<int16_t>(const int32_t vals[MIPP_N_INT16]) {
	return mipp_avx_set_k_int16( vals);
}
template <>
inline rvm<int8_t, 1> set_k<int8_t>(const int32_t vals[MIPP_N_INT8]) {
	return mipp_avx_set_k_int8( vals);
}
template <>
inline rvm<uint64_t, 1> set_k<uint64_t>(const int32_t vals[MIPP_N_UINT64]) {
	return mipp_avx_set_k_uint64( vals);
}
template <>
inline rvm<uint32_t, 1> set_k<uint32_t>(const int32_t vals[MIPP_N_UINT32]) {
	return mipp_avx_set_k_uint32( vals);
}
template <>
inline rvm<uint16_t, 1> set_k<uint16_t>(const int32_t vals[MIPP_N_UINT16]) {
	return mipp_avx_set_k_uint16( vals);
}
template <>
inline rvm<uint8_t, 1> set_k<uint8_t>(const int32_t vals[MIPP_N_UINT8]) {
	return mipp_avx_set_k_uint8( vals);
}
inline rvd<float64_t,1> set1(const float64_t v0) {
	return mipp_avx_set1_float64(v0);
}
inline rvd<float32_t,1> set1(const float32_t v0) {
	return mipp_avx_set1_float32(v0);
}
inline rvd<int64_t,1> set1(const int64_t v0) {
	return mipp_avx_set1_int64(v0);
}
inline rvd<int32_t,1> set1(const int32_t v0) {
	return mipp_avx_set1_int32(v0);
}
inline rvd<int16_t,1> set1(const int16_t v0) {
	return mipp_avx_set1_int16(v0);
}
inline rvd<int8_t,1> set1(const int8_t v0) {
	return mipp_avx_set1_int8(v0);
}
inline rvd<uint64_t,1> set1(const uint64_t v0) {
	return mipp_avx_set1_uint64(v0);
}
inline rvd<uint32_t,1> set1(const uint32_t v0) {
	return mipp_avx_set1_uint32(v0);
}
inline rvd<uint16_t,1> set1(const uint16_t v0) {
	return mipp_avx_set1_uint16(v0);
}
inline rvd<uint8_t,1> set1(const uint8_t v0) {
	return mipp_avx_set1_uint8(v0);
}
template <typename T> inline rvm<T, 1> set1_k(const int32_t v0) { std::cerr << "set1_k" << std::endl; exit(-1);}

template <>
inline rvm<int64_t, 1> set1_k<int64_t>(const int32_t v0) {
	return mipp_avx_set1_k_int64(v0);
}
template <>
inline rvm<int32_t, 1> set1_k<int32_t>(const int32_t v0) {
	return mipp_avx_set1_k_int32(v0);
}
template <>
inline rvm<int16_t, 1> set1_k<int16_t>(const int32_t v0) {
	return mipp_avx_set1_k_int16(v0);
}
template <>
inline rvm<int8_t, 1> set1_k<int8_t>(const int32_t v0) {
	return mipp_avx_set1_k_int8(v0);
}
template <>
inline rvm<uint64_t, 1> set1_k<uint64_t>(const int32_t v0) {
	return mipp_avx_set1_k_uint64(v0);
}
template <>
inline rvm<uint32_t, 1> set1_k<uint32_t>(const int32_t v0) {
	return mipp_avx_set1_k_uint32(v0);
}
template <>
inline rvm<uint16_t, 1> set1_k<uint16_t>(const int32_t v0) {
	return mipp_avx_set1_k_uint16(v0);
}
template <>
inline rvm<uint8_t, 1> set1_k<uint8_t>(const int32_t v0) {
...
template <>
inline rvd<float64_t, 1> set0<float64_t>() {
	return mipp_avx_set0_float64();
}
template <>
inline rvd<float32_t, 1> set0<float32_t>() {
	return mipp_avx_set0_float32();
}
template <>
inline rvd<int64_t, 1> set0<int64_t>() {
	return mipp_avx_set0_int64();
}
template <>
inline rvd<int32_t, 1> set0<int32_t>() {
	return mipp_avx_set0_int32();
}
template <>
inline rvd<int16_t, 1> set0<int16_t>() {
	return mipp_avx_set0_int16();
}
template <>
inline rvd<int8_t, 1> set0<int8_t>() {
	return mipp_avx_set0_int8();
}
template <>
inline rvd<uint64_t, 1> set0<uint64_t>() {
	return mipp_avx_set0_uint64();
}
template <>
inline rvd<uint32_t, 1> set0<uint32_t>() {
	return mipp_avx_set0_uint32();
}
template <>
inline rvd<uint16_t, 1> set0<uint16_t>() {
	return mipp_avx_set0_uint16();
}
template <>
inline rvd<uint8_t, 1> set0<uint8_t>() {
	return mipp_avx_set0_uint8();
}
template <typename T> inline rvm<T, 1> set0_k() { std::cerr << "set0_k" << std::endl; exit(-1);}

template <>
inline rvm<float64_t, 1> set0_k<float64_t>() {
	return mipp_avx_set0_k_float64();
}
template <>
inline rvm<float32_t, 1> set0_k<float32_t>() {
	return mipp_avx_set0_k_float32();
}
template <>
inline rvm<int64_t, 1> set0_k<int64_t>() {
	return mipp_avx_set0_k_int64();
}
template <>
inline rvm<int32_t, 1> set0_k<int32_t>() {
	return mipp_avx_set0_k_int32();
}
template <>
inline rvm<int16_t, 1> set0_k<int16_t>() {
	return mipp_avx_set0_k_int16();
}
template <>
inline rvm<int8_t, 1> set0_k<int8_t>() {
	return mipp_avx_set0_k_int8();
}
template <>
inline rvm<uint64_t, 1> set0_k<uint64_t>() {
	return mipp_avx_set0_k_uint64();
}
template <>
inline rvm<uint32_t, 1> set0_k<uint32_t>() {
	return mipp_avx_set0_k_uint32();
}
template <>
inline rvm<uint16_t, 1> set0_k<uint16_t>() {
	return mipp_avx_set0_k_uint16();
}
template <>
inline rvm<uint8_t, 1> set0_k<uint8_t>() {
