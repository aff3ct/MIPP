...
function compile {
	...
	mkdir $build
	cd $build
	cmake .. -G"Unix Makefiles" -DCMAKE_CXX_COMPILER=g++ -DCMAKE_BUILD_TYPE=Release -DCMAKE_CXX_FLAGS="-Wall -funroll-loops -finline-functions $2" -DCMAKE_EXE_LINKER_FLAGS="-static -static-libgcc -static-libstdc++" -DMIPP_STATIC_LIB=ON
...
compile "${build_root}_avx2_bmi2"     "-mavx2 -mbmi2"
compile "${build_root}_avx2_bmi2_fma" "-mavx2 -mbmi2 -mfma"
compile "${build_root}_avx512f"       "-mavx512f"
compile "${build_root}_avx512bw"      "-mavx512f -mavx512bw"
compile "${build_root}_avx512vbmi2"   "-mavx512f -mavx512bw -mavx512vbmi -mavx512vbmi2"
