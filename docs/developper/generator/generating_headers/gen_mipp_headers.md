...
The `gen_mipp_headers.py` is a "glue" script that you run to generate every 
header in the MIPP library. 
...
**TODO: link to relevant functions documentation, link to README to explain how 
to run the script.**