...
void SetTest::test_msk_set1()
{
	try
	{
		...
		mipp::reg r0 = mipp::cvt_msk_reg<mipp::N<T>()>(m0);
		mipp::reg r1 = mipp::cvt_msk_reg<mipp::N<T>()>(m1);
...
void SetTest::test_msk_set()
{
	try
	{
		...
		mipp::reg r = mipp::cvt_msk_reg<mipp::N<T>()>(m);
...
void SetTest::test_Msk_set1()
{
	try
	{
		...
		mipp::reg r0 = mipp::cvt_msk_reg<mipp::N<T>()>(m0.m);
...
void SetTest::test_Msk_set()
{
	try
	{
		...
		mipp::reg r = mipp::cvt_msk_reg<mipp::N<T>()>(m.m);
