...
void MaxTest::test_reg_maskz_max()
{
	try
	{
		...
		mipp::reg r3 = mipp::maskz<mipp::max<T>, T>(m, r1, r2);
...
void MaxTest::test_Reg_maskz_max()
{
	try
	{
		...
		mipp::Reg<T> r3 = mipp::maskz<mipp::max<T>>(m, r1, r2);
...
void MaxTest::test_reg_mask_max()
{
	try
	{
		...
		mipp::reg r4 = mipp::mask<mipp::max<T>, T>(m, r3, r1, r2);
...
void MaxTest::test_Reg_mask_max()
{
	try
	{
		...
		mipp::Reg<T> r4 = mipp::mask<mipp::max<T>>(m, r3, r1, r2);
