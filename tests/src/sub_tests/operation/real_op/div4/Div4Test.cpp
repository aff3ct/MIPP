...
void Div4Test::test_reg_maskz_div4()
{
	try
	{
		...
		mipp::reg r2 = mipp::maskz<mipp::div4<T>, T>(m, r1);
...
void Div4Test::test_Reg_maskz_div4()
{
	try
	{
		...
		mipp::Reg<T> r2 = mipp::maskz<mipp::div4<T>>(m, r1);
...
void Div4Test::test_reg_mask_div4()
{
	try
	{
		...
		mipp::reg r3 = mipp::mask<mipp::div4<T>, T>(m, r2, r1);
...
void Div4Test::test_Reg_mask_div4()
{
	try
	{
		...
		mipp::Reg<T> r3 = mipp::mask<mipp::div4<T>>(m, r2, r1);
