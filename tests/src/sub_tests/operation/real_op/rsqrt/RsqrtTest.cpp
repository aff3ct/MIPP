...
void RsqrtTest::test_reg_maskz_rsqrt()
{
	try
	{
		...
		mipp::reg r2 = mipp::maskz<mipp::rsqrt<T>, T>(m, r1);
...
void RsqrtTest::test_Reg_maskz_rsqrt()
{
	try
	{
		...
		mipp::Reg<T> r2 = mipp::maskz<mipp::rsqrt<T>>(m, r1);
...
void RsqrtTest::test_reg_mask_rsqrt()
{
	try
	{
		...
		mipp::reg r3 = mipp::mask<mipp::rsqrt<T>, T>(m, r2, r1);
...
void RsqrtTest::test_Reg_mask_rsqrt()
{
	try
	{
		...
		mipp::Reg<T> r3 = mipp::mask<mipp::rsqrt<T>>(m, r2, r1);
