...
void FmsubTest::test_reg_maskz_fmsub()
{
	try
	{
		...
		mipp::reg r4 = mipp::maskz<mipp::fmsub<T>, T>(m, r1, r2, r3);
...
void FmsubTest::test_Reg_maskz_fmsub()
{
	try
	{
		...
		mipp::Reg<T> r4 = mipp::maskz<mipp::fmsub<T>>(m, r1, r2, r3);
...
void FmsubTest::test_reg_mask_fmsub()
{
	try
	{
		...
		mipp::reg r5 = mipp::mask<mipp::fmsub<T>, T>(m, r4, r1, r2, r3);
...
void FmsubTest::test_Reg_mask_fmsub()
{
	try
	{
		...
		mipp::Reg<T> r5 = mipp::mask<mipp::fmsub<T>>(m, r4, r1, r2, r3);
