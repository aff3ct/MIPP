...
class TestzTest : public CppUnit::TestFixture
{
	...
	CPPUNIT_TEST(test_reg_testz1_int8);
#endif
	CPPUNIT_TEST(test_Reg_testz_int8);
	CPPUNIT_TEST(test_Reg_testz1_int8);
#ifndef MIPP_NO
	CPPUNIT_TEST(test_msk_testz_int8);
	CPPUNIT_TEST(test_msk_testz1_int8);
#endif
	CPPUNIT_TEST(test_Msk_testz_int8);
	CPPUNIT_TEST(test_Msk_testz1_int8);
	...
	CPPUNIT_TEST(test_reg_testz1_int16);
#endif
	CPPUNIT_TEST(test_Reg_testz_int16);
	CPPUNIT_TEST(test_Reg_testz1_int16);
#ifndef MIPP_NO
	CPPUNIT_TEST(test_msk_testz_int16);
	CPPUNIT_TEST(test_msk_testz1_int16);
#endif
	CPPUNIT_TEST(test_Msk_testz_int16);
	CPPUNIT_TEST(test_Msk_testz1_int16);
#endif
	...
	CPPUNIT_TEST(test_reg_testz1_int32);
#endif
	CPPUNIT_TEST(test_Reg_testz_int32);
	CPPUNIT_TEST(test_Reg_testz1_int32);
#ifndef MIPP_NO
	CPPUNIT_TEST(test_msk_testz_int32);
	CPPUNIT_TEST(test_msk_testz1_int32);
#endif
	CPPUNIT_TEST(test_Msk_testz_int32);
	CPPUNIT_TEST(test_Msk_testz1_int32);
	...
	CPPUNIT_TEST(test_reg_testz1_int64);
#endif
	CPPUNIT_TEST(test_Reg_testz_int64);
	CPPUNIT_TEST(test_Reg_testz1_int64);
#ifndef MIPP_NO
	CPPUNIT_TEST(test_msk_testz_int64);
	CPPUNIT_TEST(test_msk_testz1_int64);
#endif
	CPPUNIT_TEST(test_Msk_testz_int64);
	CPPUNIT_TEST(test_Msk_testz1_int64);
#endif
...
public:
	...
	void test_reg_testz1_int8();
	void test_reg_testz1_int16();
	void test_reg_testz1_int32();
	void test_reg_testz1_int64();
	...
	void test_msk_testz1_int8();
	void test_msk_testz1_int16();
	void test_msk_testz1_int32();
	void test_msk_testz1_int64();
