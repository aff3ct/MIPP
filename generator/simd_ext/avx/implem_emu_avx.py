...
tpl_implem_emu_avx = {
    ...
    "set_k-64f":  { "format": "long",  "code": "return mipp_avx_cast_k_int64_float64(mipp_avx_set_k_int64(vals));" },
    "set_k-32f":  { "format": "long",  "code": "return mipp_avx_cast_k_int32_float32(mipp_avx_set_k_int32(vals));" },
