...
"""// long version
    ...
    "set1"                : { "format": "short", "code": "{{ isa.prefix }}_{{ instr_name }}_{{ isa_dt_par.data_ext }}((msk) 0, ~((msk) 0);"},
...
"""// long version
	%r<tp>% tmp;
	tmp.m = {{ isa.prefix }}_{{ instr_name }}_{{ isa_dt_par.data_ext }}_mask(r0.r, r1.r, _CMP_NEQ_OQ);
	return %tomsk<tp>%(tmp);""" },
    "cmplt_float"         : { "format": "long", "code":
"""// long version
	%r<tp>% tmp;
	tmp.m = {{ isa.prefix }}_{{ instr_name }}_{{ isa_dt_par.data_ext }}_mask(r0.r, r1.r, _CMP_LT_OS);
	return %tomsk<tp>%(tmp);""" },
    "cmple_float"         : { "format": "long", "code":
"""// long version
	%r<tp>% tmp;
	tmp.m = {{ isa.prefix }}_{{ instr_name }}_{{ isa_dt_par.data_ext }}_mask(r0.r, r1.r, _CMP_LE_OS);
	return %tomsk<tp>%(tmp);""" },
    "cmpgt_float"         : { "format": "long", "code":
""" %r<tp>% tmp;
    tmp.m = {{ isa.prefix }}_{{ instr_name }}_{{ isa_dt_par.data_ext }}_mask(r0.r, r1.r, _CMP_GT_OS);
    return %tomsk<tp>%(tmp);""" },    
...
implems_avx512 = {
    ...
    "set1"   : [
        { "instr_name" : "set1",      "datatypes": all_float,                    "template": tpl_implem_avx512["set1"]                                                                                                          },
        { "instr_name" : "set1",      "datatypes": [int64],                      "template": tpl_implem_avx512["set1x"]                                                                                                         },
        { "instr_name" : "set1",      "datatypes": [int32, int16, int8],         "template": tpl_implem_avx512["set1"]                                                                                                          } ],
    "set0"   : [
        { "instr_name" : "setzero",   "datatypes": all_datatypes,                "template": tpl_implem_avx512["set0"]                                                                                                          } ],
    "set0_k": [
        { "instr_name": "setzero",    "datatypes": all_datatypes,                "template": tpl_implem_avx512["set0_k"]                                                                                                        } ],
    #"low_k": [
    ...
    #    { "instr_name": "kunpackb",  "datatypes": [int16],                      "template": tpl_implem_avx512["low_k"]                                                                                                         } ],
    "sqrt": [
    ...
    "toreg"  : [
        { "instr_name" : "toreg",     "datatypes": all_datatypes,                "template": tpl_implem_avx512["toreg"]                                                                                                         } ],
    "hadd": [
