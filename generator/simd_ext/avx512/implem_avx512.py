...
"""// long format
	...
	%r<c:int|b:tp>% res = %{{instr_name}}<c:int|b:tp>%(r0s, r1s);
...
"""// long format
    ...
    %r<tr>% res;
    res.r = {{ isa.prefix }}_{{ instr_name }}{{ isa_dt_par.data_ext }}_{{ isa_dt_ret.data_ext_var }}({{ isa.prefix }}_cast{{ isa_dt_par.data_ext_logi }}_si256(r0.r));
    return res;
    """},
}
...
#       { "instr_name": "kunpackb",   "datatypes": [int16],                                  "template": tpl_implem_avx512["low_k"],                                                                                                                                 } ], # low_k
    ...
    "add": [
        ...
        { "instr_name": "add",        "datatypes": [uint32, uint64],                         "template": tpl_implem_avx512["arith_2args_u"],                                                                                                                         },
    ...
    "sub": [
        ...
        { "instr_name": "sub",        "datatypes": [uint32, uint64],                         "template": tpl_implem_avx512["arith_2args_u"],                                                                                                                         },
        { "instr_name": "subs",       "datatypes": [int16, int8, uint16, uint8],             "template": tpl_implem_avx512["arith_2args"],      "if": "defined(__AVX512BW__)"                                                                                        } ], # sub
    "mul": [
    ...
    "cmpeq": [
        { "instr_name": "cmpeq",      "datatypes": [int32, int64, uint32, uint64],           "template": tpl_implem_avx512["cmp_int"],                                                                                                                               },
        { "instr_name": "cmpeq",      "datatypes": [int16, int8, uint16, uint8] ,            "template": tpl_implem_avx512["cmp_int"],          "if": "defined(__AVX512BW__)"                                                                                        },
    ...
    "cmpneq": [
        ...
        { "instr_name": "cmpneq",     "datatypes": [int32, int64, uint32, uint64],           "template": tpl_implem_avx512["cmp_int"],                                                                                                                               },
        { "instr_name": "cmpneq",     "datatypes": [int16, int8, uint16, uint8],             "template": tpl_implem_avx512["cmp_int"],          "if": "defined(__AVX512BW__)"                                                                                        } ], # cmpneq
    "cmplt": [
        { "instr_name": "cmp",        "datatypes": all_float,                                "template": tpl_implem_avx512["cmplt_float"],                                                                                                                           },
        { "instr_name": "cmplt",      "datatypes": [int32, int64, uint32, uint64],           "template": tpl_implem_avx512["cmp_int"],                                                                                                                               },
        { "instr_name": "cmplt",      "datatypes": [int16, int8, uint16, uint8],             "template": tpl_implem_avx512["cmp_int"],          "if": "defined(__AVX512BW__)"                                                                                        } ], # cmplt
    "cmple": [
        { "instr_name": "cmp",        "datatypes": all_float,                                "template": tpl_implem_avx512["cmple_float"],                                                                                                                           },
        { "instr_name": "cmple",      "datatypes": [int32, int64, uint32, uint64],           "template": tpl_implem_avx512["cmp_int"],                                                                                                                               },
        { "instr_name": "cmple",      "datatypes": [int16, int8, uint16, uint8],             "template": tpl_implem_avx512["cmp_int"],          "if": "defined(__AVX512BW__)"                                                                                        } ], # cmple
    "cmpge": [
        { "instr_name": "cmpge",      "datatypes": [int32, int64, uint32, uint64],           "template": tpl_implem_avx512["cmp_int"],                                                                                                                               },
        { "instr_name": "cmpge",      "datatypes": [int16, int8, uint16, uint8],             "template": tpl_implem_avx512["cmp_int"],          "if": "defined(__AVX512BW__)"                                                                                        },
    ...
    "cmpgt": [
        ...
        { "instr_name": "cmpgt",      "datatypes": [int32, int64, uint32, uint64],           "template": tpl_implem_avx512["cmp_int"],                                                                                                                               },
        { "instr_name": "cmpgt",      "datatypes": [int16, int8, uint16, uint8],             "template": tpl_implem_avx512["cmp_int"],          "if": "defined(__AVX512BW__)"                                                                                        } ], # cmpgt
    "round": [
...
#       { "instr_name": "mul",        "datatypes": [int32],                                  "template": tpl_implem_avx512["reduce_32"],        "if": "defined(__AVX512F__)"                                                                                         },
    ...
    "gather": [
        { "instr_name": "gather",     "datatypes": ["float64", "float32", "int64", "int32"], "template": tpl_implem_avx512["gather"],           "if": "defined(__AVX512F__)"                                                                                         },
        { "instr_name": "gather",     "datatypes": ["float64", "int64"],                     "template": tpl_implem_avx512["gather_masks_64"],  "if": "defined(__AVX512F__)",                                                                    "version" : "masks" },
        { "instr_name": "gather",     "datatypes": ["float64", "int64"],                     "template": tpl_implem_avx512["gather_maskz_64"],  "if": "defined(__AVX512F__)",                                                                    "version" : "maskz" },
        { "instr_name": "gather",     "datatypes": ["float32", "int32"],                     "template": tpl_implem_avx512["gather_masks_32"],  "if": "defined(__AVX512F__)",                                                                    "version" : "masks" },
        { "instr_name": "gather",     "datatypes": ["float32", "int32"],                     "template": tpl_implem_avx512["gather_maskz_32"],  "if": "defined(__AVX512F__)",                                                                    "version" : "maskz" } ], # gather
    "scatter": [
        { "instr_name": "scatter",    "datatypes": ["float64", "float32", "int64", "int32"], "template": tpl_implem_avx512["scatter"],          "if": "defined(__AVX512F__)"                                                                                         },
        { "instr_name": "scatter",    "datatypes": ["float64", "int64"],                     "template": tpl_implem_avx512["scatter_mask_64"],  "if": "defined(__AVX512F__)",                                                                    "version" : "mask"  },
        { "instr_name": "scatter",    "datatypes": ["float32", "int32"],                     "template": tpl_implem_avx512["scatter_mask_32"],  "if": "defined(__AVX512F__)",                                                                    "version" : "mask"  },
        { "instr_name": "scatter",    "datatypes": ["float64", "float32", "int64", "int32"], "template": tpl_implem_avx512["scatter_maskz"],    "if": "defined(__AVX512F__)",                                                                    "version" : "maskz" } ], # scatter
    "wcvt": [
        { "instr_name": "cvt",        "datatypes": ["uint32,uint64"],                        "template": tpl_implem_avx512["wcvt_int_uint"], }
    ]
 }
