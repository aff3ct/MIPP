...
\t{{reg_type_scalar}} s1 = mipp::load<{{dt_ext}}, 1, mipp::ISA::SCALAR>(inputs1); // for scalar tests
\t{{reg_type_scalar}} s2 = mipp::load<{{dt_ext}}, 1, mipp::ISA::SCALAR>(inputs2); // for scalar tests
"""
...
\t{{reg_type_scalar}} s3 = mipp::{{func}}(s1, s2); // for scalar tests
"""
