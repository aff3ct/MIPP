...
# SCALAR VEC DECL
# --------------------------------------------
DECL_VECTOR_SIZE = """\tconst int vectorSize = mipp::N<T, {{lmul_coeff}}>();"""
...
# --------------------------------------------
LOAD_2ARGS_REG = """\t{{reg_type}} r1 = mipp::load<{{dt_ext}}, {{lmul_coeff}}>(inputs1), r2 = mipp::load<{{dt_ext}}, {{lmul_coeff}}>(inputs2);"""
LOAD_1ARG_REG = """\t{{reg_type}} r1 = mipp::load<{{dt_ext}}, {{lmul_coeff}}>(inputs1);"""
LOAD_1ARG_MASK = """\t{{msk_type}} m1 = mipp::set_k<T, {{lmul_coeff}}>(inputs1);"""
LOAD_1SCALAR_REG = """\t{{reg_type}} r1 = mipp::set1<T, {{lmul_coeff}}>(input1);"""
...
LOAD_SET1_2ARGS_REG = """\t{{reg_type}} r1 = mipp::set1<T, {{lmul_coeff}}>((T)1); \n\t{{reg_type}} r2 = mipp::set1<T, {{lmul_coeff}}>((T)2);"""

LOAD_2ARGS_MASK = """\t{{msk_type}} m1 = mipp::set_k<T, {{lmul_coeff}}>(inputs1); 
\t{{msk_type}} m2 = mipp::set_k<T, {{lmul_coeff}}>(inputs2);"""

LOAD_3ARGS_REG = """\t{{reg_type}} r1 = mipp::load<T, {{lmul_coeff}}>(inputs1);
\t{{reg_type}} r2 = mipp::load<T, {{lmul_coeff}}>(inputs2);
\t{{reg_type}} r3 = mipp::load<T, {{lmul_coeff}}>(inputs3);"""

LOAD_CAST_2ARGS = """\t{{reg1_type}} r1 = mipp::load<T, {{lmul_coeff}}>(inputs1);"""
...
OP_STORE = """\tmipp::store<T, {{lmul_coeff}}>(inputs2, r1);"""
...
OP_CAST = """\t{{reg2_type}} r2 = mipp::cast_{{dt1_ext}}<T, {{lmul_coeff}}>(r1);"""
OP_CAST_MSK = """\t{{msk2_type}} m2 = mipp::cast_{{dt1_ext}}<T, {{lmul_coeff}}>(m1);"""
