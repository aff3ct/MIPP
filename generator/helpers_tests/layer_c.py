...
# FN decl 
# --------------------------------------------
FUNC_DECL = """static void test_cmipp_{{func}}_{{dt_ext}}(){"""
FUNC_DECL_GATHER = """static void test_cmipp_{{func}}_{{dt_ext}}_{{dt_ext}}(){"""
FUNC_DECL_SCATTER = """static void test_cmipp_{{func}}_{{dt_ext}}_{{dt_ext}}(){"""
...
# 1 array is random values, 1 is indexes that doesn't cross array boundaries
INIT_GATHER = """
\tfor(size_t i = 0; i < {{size}}; i++)
{
\t\tinputs1[i] = rnd::uniform<{{dt_ext}}_t>(seed);
