...
implems_mask_generic_emu = {
	...
	"exp" : [
		...
		{ "instr_name": "exp",  "datatypes" : all_float, "version" : "masks", "template" : { "format" :"long", "code" : tpl_mask_generic_emu["ret_reg_1arg_reg"]["code"] + SNIPPET_END_MSKS}},
  	],
	...
	"log" : [
		...
		{ "instr_name": "log",  "datatypes" : all_float, "version" : "masks", "template" : { "format" :"long", "code" : tpl_mask_generic_emu["ret_reg_1arg_reg"]["code"] + SNIPPET_END_MSKS}},
  	],
	...
	"pow" : [
		...
		{ "instr_name": "pow",  "datatypes" : all_float, "version" : "masks", "template" : { "format" :"long", "code" : tpl_mask_generic_emu["ret_reg_2args_reg"]["code"] + SNIPPET_END_MSKS}},
  	],
	...
	"lshift" : [
		...
		{ "instr_name": "lshift",  "datatypes" : all_datatypes, "version" : "masks", "template" : { "format" :"long", "code" : tpl_mask_generic_emu["ret_reg_2args_reg_val"]["code"] + SNIPPET_END_MSKS}},
	],
