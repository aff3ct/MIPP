...
implems_mask_generic_emu = {
    ...
    "store": [
        ...
        { "instr_name": "store",   "datatypes": all_datatypes,     "version": "maskz", "template": tpl_mask_generic_emu["store_mskz"]                                                                     } ], # store
    "storeu": [
        { "instr_name": "storeu",  "datatypes": all_datatypes,     "version": "mask",  "template": tpl_mask_generic_emu["storeu_msk"]                                                                     },
        { "instr_name": "storeu",  "datatypes": all_datatypes,     "version": "maskz", "template": tpl_mask_generic_emu["storeu_mskz"]                                                                    } ], # storeu
    # ---- LOAD ----
    "load": [
        { "instr_name": "load",    "datatypes": all_datatypes,     "version": "masks", "template": tpl_mask_generic_emu["load_msks"]                                                                      },
        { "instr_name": "load",    "datatypes": all_datatypes,     "version": "maskz", "template": tpl_mask_generic_emu["load_mskz"]                                                                      } ], # load
    "loadu": [
        { "instr_name": "loadu",   "datatypes": all_datatypes,     "version": "masks", "template": tpl_mask_generic_emu["load_msks"]                                                                      },
        { "instr_name": "loadu",   "datatypes": all_datatypes,     "version": "maskz", "template": tpl_mask_generic_emu["load_mskz"]                                                                      } ], # loadu
    "set": [
        { "instr_name": "set",     "datatypes": all_datatypes,     "version": "masks", "template": { "format": "long", "code": tpl_mask_generic_emu["set"]["code"]                   + SNIPPET_END_MSKS } } ], # set
    "set1": [
        { "instr_name": "set1",    "datatypes": all_datatypes,     "version": "masks", "template": { "format": "long", "code": tpl_mask_generic_emu["set1"]["code"]                  + SNIPPET_END_MSKS } } ], # set1
    "set0": [
        { "instr_name": "set0",    "datatypes": all_datatypes,     "version": "masks", "template": { "format": "long", "code": tpl_mask_generic_emu["set0"]["code"]                  + SNIPPET_END_MSKS } } ], # set0
    # ---- ARITHMETIC ----
    "add": [
        ...
        { "instr_name": "add",     "datatypes": all_datatypes,     "version": "masks", "template": { "format": "long", "code": tpl_mask_generic_emu["ret_reg_2args_reg"]["code"]     + SNIPPET_END_MSKS } } ], # add
    "sub": [
        ...
        { "instr_name": "sub",     "datatypes": all_datatypes,     "version": "masks", "template": { "format": "long", "code": tpl_mask_generic_emu["ret_reg_2args_reg"]["code"]     + SNIPPET_END_MSKS } } ], # sub
    "mul": [
        ...
        { "instr_name": "mul",     "datatypes": all_datatypes,     "version": "masks", "template": { "format": "long", "code": tpl_mask_generic_emu["ret_reg_2args_reg"]["code"]     + SNIPPET_END_MSKS } } ], # mul
    "div": [
        ...
        { "instr_name": "div",     "datatypes": all_float,         "version": "masks", "template": { "format": "long", "code": tpl_mask_generic_emu["ret_reg_2args_reg"]["code"]     + SNIPPET_END_MSKS } } ], # div
    "div2": [
        ...
        { "instr_name": "div2",    "datatypes": all_float,         "version": "masks", "template": { "format": "long", "code": tpl_mask_generic_emu["ret_reg_1arg_reg"]["code"]      + SNIPPET_END_MSKS } } ], # div2
    "fmadd": [
        ...
        { "instr_name": "fmadd",   "datatypes": all_float+[int32], "version": "masks", "template": { "format": "long", "code": tpl_mask_generic_emu["ret_reg_3args_reg"]["code"]     + SNIPPET_END_MSKS } } ], # fmadd
    "fmsub": [
        ...
        { "instr_name": "fmsub",   "datatypes": all_float+[int32], "version": "masks", "template": { "format": "long", "code": tpl_mask_generic_emu["ret_reg_3args_reg"]["code"]     + SNIPPET_END_MSKS } } ], # fmsub
    "fnmadd": [
        ...
        { "instr_name": "fnmadd",  "datatypes": all_float+[int32], "version": "masks", "template": { "format": "long", "code": tpl_mask_generic_emu["ret_reg_3args_reg"]["code"]     + SNIPPET_END_MSKS } } ], # fnmadd
    "fnmsub": [
        ...
        { "instr_name": "fnmsub",  "datatypes": all_float+[int32], "version": "masks", "template": { "format": "long", "code": tpl_mask_generic_emu["ret_reg_3args_reg"]["code"]     + SNIPPET_END_MSKS } } ], # fnmsub
    "div4": [
        ...
        { "instr_name": "div4",    "datatypes": all_float,         "version": "masks", "template": { "format": "long", "code": tpl_mask_generic_emu["ret_reg_1arg_reg"]["code"]      + SNIPPET_END_MSKS } } ], # div4
    # ---- COMPARISON ----
    # only maskz for comparison
    "cmpeq": [
        {"instr_name": "cmpeq",    "datatypes": all_datatypes,     "version": "maskz", "template": { "format": "long", "code": tpl_mask_generic_emu["cmp_2args"]["code"] }                                } ], # cmpeq
    "cmpneq": [
        {"instr_name": "cmpneq",   "datatypes": all_datatypes,     "version": "maskz", "template": { "format": "long", "code": tpl_mask_generic_emu["cmp_2args"]["code"] }                                } ], # cmpneq
    "cmpgt": [
        {"instr_name": "cmpgt",    "datatypes": all_datatypes,     "version": "maskz", "template": { "format": "long", "code": tpl_mask_generic_emu["cmp_2args"]["code"] }                                } ], # cmpgt
    "cmpge": [
        {"instr_name": "cmpge",    "datatypes": all_datatypes,     "version": "maskz", "template": { "format": "long", "code": tpl_mask_generic_emu["cmp_2args"]["code"] }                                } ], # cmpge
    "cmplt": [
        {"instr_name": "cmplt",    "datatypes": all_datatypes,     "version": "maskz", "template": { "format": "long", "code": tpl_mask_generic_emu["cmp_2args"]["code"] }                                } ], # cmplt
    "cmple": [
        {"instr_name": "cmple",    "datatypes": all_datatypes,     "version": "maskz", "template": { "format": "long", "code": tpl_mask_generic_emu["cmp_2args"]["code"] }                                } ], # cmple
    # ---- MATH ----
    "sqrt": [
        ...
        { "instr_name": "sqrt",    "datatypes": all_float,         "version": "masks", "template": { "format": "long", "code": tpl_mask_generic_emu["ret_reg_1arg_reg"]["code"]      + SNIPPET_END_MSKS } } ], # sqrt
    "rsqrt": [
        ...
        { "instr_name": "rsqrt",   "datatypes": all_float,         "version": "masks", "template": { "format": "long", "code": tpl_mask_generic_emu["ret_reg_1arg_reg"]["code"]      + SNIPPET_END_MSKS } } ], # rsqrt
    "round": [
        ...
        { "instr_name": "round",   "datatypes": all_datatypes,     "version": "masks", "template": { "format": "long", "code": tpl_mask_generic_emu["ret_reg_1arg_reg"]["code"]      + SNIPPET_END_MSKS } } ], # round
    "exp": [
        { "instr_name": "exp",     "datatypes": all_float,         "version": "mask",  "template": { "format": "long", "code": tpl_mask_generic_emu["ret_reg_1arg_reg"]["code"]      + SNIPPET_END_MSK }  },
        { "instr_name": "exp",     "datatypes": all_float,         "version": "maskz", "template": { "format": "long", "code": tpl_mask_generic_emu["ret_reg_1arg_reg"]["code"]      + SNIPPET_END_MSKZ } },
        { "instr_name": "exp",     "datatypes": all_float,         "version": "masks", "template": { "format": "long", "code": tpl_mask_generic_emu["ret_reg_1arg_reg"]["code"]      + SNIPPET_END_MSKS } } ], # exp
    "log": [
        { "instr_name": "log",     "datatypes": all_float,         "version": "mask",  "template": { "format": "long", "code": tpl_mask_generic_emu["ret_reg_1arg_reg"]["code"]      + SNIPPET_END_MSK }  },
        { "instr_name": "log",     "datatypes": all_float,         "version": "maskz", "template": { "format": "long", "code": tpl_mask_generic_emu["ret_reg_1arg_reg"]["code"]      + SNIPPET_END_MSKZ } },
        { "instr_name": "log",     "datatypes": all_float,         "version": "masks", "template": { "format": "long", "code": tpl_mask_generic_emu["ret_reg_1arg_reg"]["code"]      + SNIPPET_END_MSKS } } ], # log
    "pow": [
        { "instr_name": "pow",     "datatypes": all_float,         "version": "mask",  "template": { "format": "long", "code": tpl_mask_generic_emu["ret_reg_2args_reg"]["code"]     + SNIPPET_END_MSK }  },
        { "instr_name": "pow",     "datatypes": all_float,         "version": "maskz", "template": { "format": "long", "code": tpl_mask_generic_emu["ret_reg_2args_reg"]["code"]     + SNIPPET_END_MSKZ } },
        { "instr_name": "pow",     "datatypes": all_float,         "version": "masks", "template": { "format": "long", "code": tpl_mask_generic_emu["ret_reg_2args_reg"]["code"]     + SNIPPET_END_MSKS } } ], # pow
    # ---- LOGIC ----
    ...
    "andb": [
        ...
        { "instr_name": "andb",    "datatypes": all_datatypes,     "version": "masks", "template": { "format": "long", "code": tpl_mask_generic_emu["ret_reg_2args_reg"]["code"]     + SNIPPET_END_MSKS } } ], # andb
    "andnb": [
        ...
        { "instr_name": "andnb",   "datatypes": all_datatypes,     "version": "masks", "template": { "format": "long", "code": tpl_mask_generic_emu["ret_reg_2args_reg"]["code"]     + SNIPPET_END_MSKS } } ], # andnb
    "orb": [
        ...
        { "instr_name": "orb",     "datatypes": all_datatypes,     "version": "masks", "template": { "format": "long", "code": tpl_mask_generic_emu["ret_reg_2args_reg"]["code"]     + SNIPPET_END_MSKS } } ], # orb
    "xorb": [
        ...
        { "instr_name": "xorb",    "datatypes": all_datatypes,     "version": "masks", "template": { "format": "long", "code": tpl_mask_generic_emu["ret_reg_2args_reg"]["code"]     + SNIPPET_END_MSKS } } ], # xorb
    "msb": [
        ...
        { "instr_name": "msb",     "datatypes": all_datatypes,     "version": "masks", "template": { "format": "long", "code": tpl_mask_generic_emu["ret_reg_1arg_reg"]["code"]      + SNIPPET_END_MSKS } } ], # msb
    "notb": [
        ...
        { "instr_name": "notb",    "datatypes": all_datatypes,     "version": "masks", "template": { "format": "long", "code": tpl_mask_generic_emu["ret_reg_1arg_reg"]["code"]      + SNIPPET_END_MSKS } } ], # notb
    "lshift": [
        { "instr_name": "lshift",  "datatypes": all_datatypes,     "version": "mask",  "template": { "format": "long", "code": tpl_mask_generic_emu["ret_reg_2args_reg_val"]["code"] + SNIPPET_END_MSK }  },
        { "instr_name": "lshift",  "datatypes": all_datatypes,     "version": "maskz", "template": { "format": "long", "code": tpl_mask_generic_emu["ret_reg_2args_reg_val"]["code"] + SNIPPET_END_MSKZ } },
        { "instr_name": "lshift",  "datatypes": all_datatypes,     "version": "masks", "template": { "format": "long", "code": tpl_mask_generic_emu["ret_reg_2args_reg_val"]["code"] + SNIPPET_END_MSKS } } ], # lshift
    # ---- REDUCTIONS ----
    ...
    "hadd": [
        { "instr_name": "hadd",    "datatypes": all_datatypes,     "version": "maskz", "template": tpl_mask_generic_emu["hadd_maskz"]                                                                     } ], # hadd
    "hmul": [
        { "instr_name": "hmul",    "datatypes": all_datatypes,     "version": "maskz", "template": tpl_mask_generic_emu["hmul_maskz"]                                                                     } ], # hmul
    "hmin": [
        ...
        { "instr_name": "hmin",    "datatypes": [uint8],           "version": "maskz", "template": tpl_mask_generic_emu["hmin_maskz_u8"]                                                                  } ], # hmin
    "hmax": [
        ...
        {"instr_name": "hmax",     "datatypes": [int8],            "version": "maskz", "template": tpl_mask_generic_emu["hmax_maskz_i8"]                                                                  } ], # hmax
    # ---- SELECTION ----
    "min": [
        ...
        { "instr_name": "min",     "datatypes": all_datatypes,     "version": "masks", "template": { "format": "long", "code": tpl_mask_generic_emu["ret_reg_2args_reg"]["code"]     + SNIPPET_END_MSKS } } ], # min
    "max": [
        ...
        { "instr_name": "max",     "datatypes": all_datatypes,     "version": "masks", "template": { "format": "long", "code": tpl_mask_generic_emu["ret_reg_2args_reg"]["code"]     + SNIPPET_END_MSKS } } ], # max
}
...
implems_horiz_lmul_generic_emu = {
    "set": [
        { "instr_name": "set",           "datatypes": all_datatypes,           "version": "horiz_lmul", "template": tpl_horiz_lmul_generic_emu["tpl_set"]                                          } ], # set
    "get": [
        { "instr_name": "get",           "datatypes": all_datatypes,           "version": "horiz_lmul", "template": tpl_horiz_lmul_generic_emu["tpl_get"]                                          } ], # get
    "get_k": [
        { "instr_name": "get_k",         "datatypes": all_datatypes,           "version": "horiz_lmul", "template": tpl_horiz_lmul_generic_emu["tpl_get_k"]                                        } ], # get_k
    "getfirst": [
        { "instr_name": "getfirst",      "datatypes": all_datatypes,           "version": "horiz_lmul", "template": tpl_horiz_lmul_generic_emu["tpl_getfirst"]                                     } ], # getfirst
    "testz": [
        { "instr_name": "testz",         "datatypes": all_datatypes,           "version": "horiz_lmul", "template": tpl_horiz_lmul_generic_emu["tpl_testz"]                                        } ], # testz
    "testz_2": [
        { "instr_name": "testz_2",       "datatypes": all_datatypes,           "version": "horiz_lmul", "template": tpl_horiz_lmul_generic_emu["tpl_testz_2"]                                      } ], # testz_2
    "hadd": [
        { "instr_name": "hadd",          "datatypes": all_datatypes,           "version": "horiz_lmul", "template": tpl_horiz_lmul_generic_emu["hadd"],         "dependencies" : {"add"}           } ], # hadd
    "hmul": [
        { "instr_name": "hmul",          "datatypes": all_datatypes,           "version": "horiz_lmul", "template": tpl_horiz_lmul_generic_emu["hmul"],         "dependencies" : {"mul"}           } ], # hmul
    "hmin": [
        { "instr_name": "hmin",          "datatypes": all_datatypes,           "version": "horiz_lmul", "template": tpl_horiz_lmul_generic_emu["hmin"],         "dependencies" : {"min"}           } ], # hmin
    "hmax": [
        { "instr_name": "hmax",          "datatypes": all_datatypes,           "version": "horiz_lmul", "template": tpl_horiz_lmul_generic_emu["hmax"],         "dependencies" : {"max"}           } ], # hmax
    "hadd_to_scal": [
        { "instr_name": "hadd_to_scal",  "datatypes": all_datatypes,           "version": "horiz_lmul", "template": tpl_horiz_lmul_generic_emu["hadd_to_scal"]                                     } ], # hadd_to_scal
    "hadds": [
        { "instr_name": "hadds",         "datatypes": all_datatypes,           "version": "horiz_lmul", "template": tpl_horiz_lmul_generic_emu["hadds"],        "dependencies" : {"add"}           } ], # hadds
    "hadds_to_scal": [
        { "instr_name": "hadds_to_scal", "datatypes": all_datatypes,           "version": "horiz_lmul", "template": tpl_horiz_lmul_generic_emu["hadds_to_scal"]                                    } ], # hadds_to_scal
    "set_k": [
        { "instr_name": "set_k",         "datatypes": all_datatypes,           "version": "horiz_lmul", "template": tpl_horiz_lmul_generic_emu["set_k"]                                            } ], # set_k
    "wcvt": [
