...
from codegen.implem_tracker import update_emulated

def emit_ifdef_begin_and_update_emulated(funcs, f, dt_key, ff, ifd, file, mask_kind=None):
    if ifd:
...
def emit_already_implemented_message(f, dt_key, file, generic=False):
