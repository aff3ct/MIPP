...
implems_emu = {
		...
		"notb": [
			{ "datatypes": [float64, int64], "template": tpl_implem_emu["notb-64"] },
			{ "datatypes": [float32, int32], "template": tpl_implem_emu["notb-32"] },
			{ "datatypes": [int16], "template": tpl_implem_emu["notb-16"] },
			{ "datatypes": [int8], "template": tpl_implem_emu["notb-8"] }, ],
		"notb_k": [
			{ "datatypes": [float64, int64], "template": tpl_implem_emu["notb_k-64"] },
