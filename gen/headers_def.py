...
mipp_funcs = {
	...
	"abs":     { "proto": protos["ret_reg_1arg_reg"            ], "datatypes": all_float+all_int      , "horizontal": False },
	"div2":    { "proto": protos["ret_reg_1arg_reg"            ], "datatypes": all_datatypes          , "horizontal": False },
	"div4":    { "proto": protos["ret_reg_1arg_reg"            ], "datatypes": all_datatypes          , "horizontal": False },
	...
	"fnmadd":  { "proto": protos["ret_reg_3args_reg"           ], "datatypes": all_float              , "horizontal": False },
	"fmsub":   { "proto": protos["ret_reg_3args_reg"           ], "datatypes": all_float              , "horizontal": False },
	"fnmsub":  { "proto": protos["ret_reg_3args_reg"           ], "datatypes": all_float              , "horizontal": False },
	...
	"lshiftr": { "proto": protos["ret_reg_2args_reg"           ], "datatypes": all_datatypes          , "horizontal": False },
	"rshiftr": { "proto": protos["ret_reg_2args_reg"           ], "datatypes": all_datatypes          , "horizontal": False },
	"lshift":  { "proto": protos["ret_reg_2args_reg_val"       ], "datatypes": all_datatypes          , "horizontal": False },
	"rshift":  { "proto": protos["ret_reg_2args_reg_val"       ], "datatypes": all_datatypes          , "horizontal": False },
	...
	"neg":     { "proto": protos["ret_reg_2args_reg"           ], "datatypes": all_float+all_int      , "horizontal": False },
	"neg_2":   { "proto": protos["ret_reg_2args_reg_msk"       ], "datatypes": all_float+all_int      , "horizontal": False },
