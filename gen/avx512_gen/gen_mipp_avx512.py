...
#include <immintrin.h>"""
	...
	gen_c_functions(isa_avx512, file, my_mipp_funcs, implems_avx512)
	gen_c_functions(isa_avx512, file, my_mipp_funcs, implems_emu_avx512)
	gen_c_missing_functions(isa_avx512, file, my_mipp_funcs)
...
{"""
	...
	gen_cpp_functions(isa_avx512,file, my_mipp_funcs)
