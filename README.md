...
| `maskld`        | `Reg  <T> maskld        (const Msk<N> m, const T* mem)`                     | Loads elements according to the mask `m`.                                                                                                 | `double`, `float`, `int64_t`, `int32_t`, `int16_t`, `int8_t` |
| `masklds`       | `Reg  <T> masklds       (const Msk<N> m, const T* mem)`                     | Loads elements according to the mask `m`. Safe version, only reads masked elements in memory.                                             | `double`, `float`, `int64_t`, `int32_t`, `int16_t`, `int8_t` |
